			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="user_storage">
						<img src=""> <span class="tagbutton"><img
							src="" style="width: 30px; height: 35px"> </span>
					</div>
				</div>
				<div class="modal-body">

					<div class="modal-image">
						<img src=""> <span id="tag1" class="rounded">
					...
					<div class="icon_list">
						<br /> <a href="http://www.facebook.com" target=_blank><img
							src=""></a>&nbsp&nbsp&nbsp <a
							href="http://www.instargram.com" target=_blank><img
							src=""></a>&nbsp&nbsp&nbsp <img src="">&nbsp&nbsp&nbsp
					</div>
					</br> <br />
